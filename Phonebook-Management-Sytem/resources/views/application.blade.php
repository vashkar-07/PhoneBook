...
<body>
    ...
    <div class="container" style="margin-bottom: 30px;">
        ...
        <div class="row">
            <div class="col">
                <p id="apply">Add your image</p>
            </div>
        </div>
        <form action="/wait" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{session('staff.id')}}" id="">
            <div class="row">
                <div class="col-md-3 col-lg-2 col-xl-2"><img src="/img/user.png" style="width: 150px;"></div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-4 col-xl-4">
                    ...
                    <p id="apply-2" style="margin-top: 16px;">Location:</p>
                ...
                <div class="col">
                    ...
                    <p id="apply-8">Facebook:</p><input type="text" name="facebook" style="margin-bottom: 16px;">
                    <p id="apply-7">Twitter:</p><input type="text" name="twitter" style="margin-bottom: 16px;">
                    <p id="apply-6">LinkedIn:</p><input type="text" name="linkedin" style="margin-bottom: 16px;">
                    <p id="apply-5">Github:</p><input type="text" name="github" style="margin-left: 1px;margin-bottom: 16px;"></div>
            </div>
            <div class="row">
                <div class="col-xl-1 offset-xl-4"><button class="btn btn-primary" type="submit" style="margin-left: 0px;">Apply</a></div>
            </div>
        </form>
    </div>
