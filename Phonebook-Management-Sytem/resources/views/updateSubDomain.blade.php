...
<body>
    <body>
        ...
        <div class="login-clean">
            <form method="post" action="/updateSubDomain">
            @csrf
            <input type="hidden" name="id" value="{{$id}}">
            <div class="form-group">
                <input class='form-control' type="text" name="sub_domain" placeholder="Job Title" value="{{$jobs['sub_domain_name']}}">
                <input class='form-control' type="text" name="hr" placeholder="hierarchy" value="{{$jobs['hierarchy']}}">
