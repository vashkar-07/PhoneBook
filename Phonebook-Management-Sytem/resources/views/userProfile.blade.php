        ...
        <div class="container-fluid"><i class="material-icons">perm_contact_calendar</i><a class="navbar-brand" href="userFirstPage.html">PhoneBook</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link active" href="userFirstPage.html">Home</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Notifications</a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link" href="userProfile.html"><i class="fa fa-user-circle-o"></i>&nbsp;Username</a></li>
                    <li class="nav-item"><a class="nav-link" href="index.html">Logout</a></li>
                </ul>
        </div>
        </div>
    </nav>
    <div class="container prof" style="margin-top: 30px;margin-bottom: 30px;">
        <div class="row" style="padding-top: 25px;">
            <div class="col-lg-4"><img src="assets/img/arman3.png" style="width: 180px;"></div>
            <div class="col-xl-6">
                <h2 style="color: #fff;">Ruhit Arman</h2>
                <p id="user">CSE Discipline<br>Student</p>
            </div>
            <div class="col"><button class="btn btn-info" type="button">Edit Profile</button></div>
        </div>
        <div class="row">
            <div class="col-lg-4">
                <h2>About</h2>
                <p id="user">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia,
                    ...
                    dolor sit amet..", comes from a line in section 1.10.32.<br><br></p>
            </div>
            <div class="col">
                <h2 style="color: #fff;">Contact Information</h2>
                <p id="user">Email: armanruhit09@gmail.com<br><br>Mobile: +8801533056059<br></p>
                <div class="social-links social-icons" style="width: 400px;margin-top: 28px;"><span id="user">Social Links:&nbsp;</span><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a><a href="#"><i class="fa fa-github"></i></a></div>
            </div>
        </div>
    </div>
