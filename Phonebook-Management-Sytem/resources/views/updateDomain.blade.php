...
<body>
    <body>
        ...
        <div class="login-clean">
            <form method="post" action="/updateDomain">
            @csrf
            <input type="hidden" name="id" value="{{$data['id']}}">
            <div class="form-group"><input class="form-control" type="text" name="domain" value="{{$data['domain_name']}}" placeholder="Domain name" ></div>
